...
// Skatteregler for inntektsår 2024 (ENK, tjenestebasert, ingen ansatte,
// ingen varelager). Kilder, se Sources nederst.
//
// VIKTIG: For inntektsår 2024 og tidligere finnes ingen skatteavtale i kraft
// mellom Norge og Brasil. Kreditfradrag for utenlandsk skatt følger intern
// norsk rett (sktl. § 16-20 flg.). Maksimalt kreditfradrag per land/kategori
// (§ 16-21). Ubenyttet kreditfradrag fremføres i inntil 5 år (§ 16-22).
// Krav må fremmes senest 6 mnd etter at endelig skatt er fastsatt i utlandet
// (§ 16-30).
...
func init() {
	register(Rules{
		...
		HjemmekontorSjablong:    2128,  // kr/år
...
func deductions2024() []Deduction {
	return []Deduction{
		...
		{Key: "hjemmekontor", Name: "Kostnader hjemmekontor (standardfradrag)", Description: "Sjablongfradrag for hjemmekontor. Krever minst 50% egen bruk. Alternativt faktiske kostnader.", DefaultPct: 100, SjablongAmount: 2128, Note: "Krever >=50% egen bruk av boligen i minst halve året."},
		...
		{Key: "bil_km", Name: "Bilgodtgjørelse / kjoregodtgjørelse yrkeskjoring", Description: "Yrkeskjoring med egen bil. Skattefri sats kr 3,50/km.", DefaultPct: 100, Note: "kr 3,50/km i 2024 (+1,00/km per passasjer)."},
		...
		{Key: "representasjon", Name: "Representasjon (bevertning)", Description: "Enkel bevertning av kunder/forbindelser.", DefaultPct: 100, MaxAmount: 562, Note: "Maks kr 562/person (2024), ingen brennevin. Overskrides beløpet er hele kostnaden ikke fradragsberettiget."},
	}
}
